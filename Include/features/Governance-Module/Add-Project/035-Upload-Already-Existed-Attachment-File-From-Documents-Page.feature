@PMO
Feature: Upload already existed attachment file from documents page and check error message
  I want to upload already existed attachment file from documents page and check error message
  @smoke
  Scenario: Upload already existed attachment file from documents page and check error message
