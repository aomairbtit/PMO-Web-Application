@PMO
Feature: Create new project with invalid user as manager
  I want to Create new project with invalid user as manager

  @smoke
  Scenario: Create new project with invalid user as manager
