@PMO
Feature: Verify creating project without filling optional field
  I want to verify creating project without filling optional field
  @smoke
  Scenario: Verify creating project without filling optional field
