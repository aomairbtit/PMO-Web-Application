@PMO
Feature: Update dratft project name 
  I want to Update dratft project name
  @smoke
  Scenario: Update dratft project name
    ...
    When I want to wait for page load
    When I want to check im in projects list page
    When I want to search for updated project by name
