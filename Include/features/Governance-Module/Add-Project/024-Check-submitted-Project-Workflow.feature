@PMO
Feature: Check that the submitted project start the workflow
  I want to Check that the submitted project start the workflow
  @smoke
  Scenario: Check that the submitted project start the workflow
