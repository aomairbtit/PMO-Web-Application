@PMO
Feature: Upload large attachment file from documents page and check error message
  I want to upload large attachment file from documents page and check error message
  @smoke
  Scenario: Upload large attachment file from documents page and check error message
