@PMO
Feature: Upload attachment file from documents page 
  I want to Upload attachment file from documents page
  @smoke
  Scenario: Upload attachment file from documents page
