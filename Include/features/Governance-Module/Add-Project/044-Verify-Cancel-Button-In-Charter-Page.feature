@PMO
Feature: Verify cancel button in charter page
  I want to Verify cancel button in charter page
  @smoke
  Scenario: Verify cancel button in charter page
    ...
    When I want to search for created project by name
