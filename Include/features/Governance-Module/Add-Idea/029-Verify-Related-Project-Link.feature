@PMO
Feature: Verify related project link for executed idea
  I want to Verify related project link for executed idea

  @smoke
  Scenario: Verify related project link for executed idea
    ...
    Then I want to verify Project Charter page
