$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/029-View-Project-Details.feature");
formatter.feature({
  "name": "View project details",
  "description": "  I want to view project details",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to verify project details",
  "keyword": "Then "
});
formatter.match({
  "location": "AddProjectSteps.verifyProjectDetails()"
});
formatter.result({
  "status": "skipped"
});
