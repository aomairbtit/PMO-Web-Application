$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/041-Verify-Support-Details.feature");
formatter.feature({
...
formatter.match({
  "location": "AddProjectSteps.verifyProjectCharter()"
});
formatter.result({
  "status": "skipped"
});
