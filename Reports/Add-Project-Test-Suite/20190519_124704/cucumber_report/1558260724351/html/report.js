$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/033-Upload-Large-Attachment-File-From-Documents-Page.feature");
formatter.feature({
  "name": "Upload large attachment file from documents page and check error message",
  "description": "  I want to upload large attachment file from documents page and check error message",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to add large documment from documents page",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.addLargeDocumentFromDocumentsPage()"
});
formatter.result({
  "status": "skipped"
});
formatter.step({
  "name": "I want to verify large Attachment not added and check error message",
  "keyword": "Then "
});
formatter.match({
  "location": "AddProjectSteps.verifyLargeAttachmentnotAdded()"
});
formatter.result({
  "status": "skipped"
});
