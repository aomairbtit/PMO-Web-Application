$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/004-Create-Project-with-Attachment.feature");
formatter.feature({
  "name": "Create new project with attachment",
  "description": "  I want to Create new project with attachment",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.scenario({
  "name": "Verify execute idea process",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
