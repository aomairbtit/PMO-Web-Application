$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/003-Verify-Budget-Field.feature");
formatter.feature({
  "name": "Verify budget field doesn\u0027t accept alphapet",
  "description": "  I want to verify budget field doesn\u0027t accept alphapet",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to verify budget field doesn\u0027t accept alphapet",
  "keyword": "Then "
});
formatter.match({
  "location": "AddProjectSteps.verifyBudgetField()"
});
formatter.result({
  "status": "passed"
});
