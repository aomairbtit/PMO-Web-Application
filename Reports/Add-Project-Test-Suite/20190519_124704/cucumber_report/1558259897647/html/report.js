$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/018-Verify-Related-Strategic-Objective.feature");
formatter.feature({
  "name": "Verify Related Strategic Objective",
  "description": "  I want to Verify Related Strategic Objective",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to verify related strategic objective",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.verifyRelatedStrategicObjective()"
});
formatter.result({
  "status": "passed"
});
