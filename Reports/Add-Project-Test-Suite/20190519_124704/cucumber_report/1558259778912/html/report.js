$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/014-Create-Project-with-Invalid-Manager.feature");
formatter.feature({
  "name": "Create new project with invalid user as manager",
  "description": "  I want to Create new project with invalid user as manager",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to fill project manager field with user that is not existed",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.fillProjectMangerFieldWithNotExistedUser()"
});
formatter.result({
  "status": "passed"
});
