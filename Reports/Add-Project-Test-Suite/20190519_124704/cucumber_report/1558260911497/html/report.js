$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/039-DeleteProject-Support.feature");
formatter.feature({
  "name": "Delete project support",
  "description": "  I want to Delete project support",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to delete support",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.deleteSupport()"
});
formatter.result({
  "status": "skipped"
});
