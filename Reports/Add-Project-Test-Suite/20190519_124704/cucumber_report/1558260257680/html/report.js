$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/026-Update-Draft-Project-Name.feature");
formatter.feature({
  "name": "Update dratft project name",
  "description": "  I want to Update dratft project name",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to edit draft project name",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.editProjectName()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "I want to search for updated project by name",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.searchForUpdatedProjectByName()"
});
formatter.result({
  "status": "passed"
});
