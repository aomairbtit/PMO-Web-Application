$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/028-Verify-Project-Page.feature");
formatter.feature({
  "name": "Verify project page",
  "description": "  I want to Verify project page",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to verify project page",
  "keyword": "Then "
});
formatter.match({
  "location": "AddProjectSteps.verifyProjectPage()"
});
formatter.result({
  "status": "skipped"
});
