$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/032-Delete-Attachment-File-From-Documents-Page.feature");
formatter.feature({
  "name": "Delete attachemnt file from documents page",
  "description": "  I want to Delete attachemnt file from documents page",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to delete documment frome documents page",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.deleteDocumentFromDocumentsPage()"
});
formatter.result({
  "status": "skipped"
});
