$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/015-Create-Project-with-Inactive-Manager.feature");
formatter.feature({
  "name": "Create new project with inactive user as manager",
  "description": "  I want to Create new project with inactive user as manager",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.scenario({
  "name": "Create new project with inactive user",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "I want to fill project manager field with inactive user",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.fillProjectMangerFieldWithInactiveUser()"
});
formatter.result({
  "status": "passed"
});
