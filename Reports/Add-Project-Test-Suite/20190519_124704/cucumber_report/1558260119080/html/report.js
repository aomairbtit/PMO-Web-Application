$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/025-Submit-Saved-Project.feature");
formatter.feature({
  "name": "Verify submitting saved project",
  "description": "  I want to verify submitting saved project",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to submit saved project",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.submitSavedProject()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "I want to check submitted project is at the workflow",
  "keyword": "Then "
});
formatter.match({
  "location": "AddProjectSteps.checkSubmittedProjectWorkflow()"
});
formatter.result({
  "status": "skipped"
});
