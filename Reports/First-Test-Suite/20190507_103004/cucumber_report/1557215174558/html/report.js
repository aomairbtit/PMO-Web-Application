$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Idea/028-Cancel-Execution-Idea.feature");
formatter.feature({
  "name": "Verify Cancel execution idea",
  "description": "  I want to verify Cancel execution idea",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to click on cancel creating new project button",
  "keyword": "When "
});
formatter.match({
  "location": "AddProjectSteps.clickCancelProject()"
});
formatter.result({
  "status": "skipped"
});
