$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Idea/025-Verify-Approved-Idea-Details-Page.feature");
formatter.feature({
  "name": "Verify approved idea details page",
  "description": "  I want to verify approved idea details page",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to go to approved idea details page",
  "keyword": "When "
});
formatter.match({
  "location": "AddIdeaSteps.goToApprovedIdeaDetailsPage()"
});
formatter.result({
  "status": "skipped"
});
formatter.step({
  "name": "I want to verify approved idea details page",
  "keyword": "Then "
});
formatter.match({
  "location": "AddIdeaSteps.verifyApprovedIdeaDetailsPage()"
});
formatter.result({
  "status": "skipped"
});
