$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Idea/030-View-Project-List.feature");
formatter.feature({
  "name": "View Project List",
  "description": "  I want to View Project List",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.match({
  "location": "AddIdeaSteps.clickProjectsList()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "AddIdeaSteps.verifyProjectListPage()"
});
formatter.result({
  "status": "passed"
});
