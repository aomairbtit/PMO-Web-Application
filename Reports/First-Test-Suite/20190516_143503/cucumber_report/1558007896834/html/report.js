$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Governance-Module/Add-Project/030-Verify-Documents-Page.feature");
formatter.feature({
  "name": "Verify documents page",
  "description": "  I want to Verify documents page",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
...
formatter.step({
  "name": "I want to verify documents page page",
  "keyword": "When "
});
formatter.match({});
formatter.result({
