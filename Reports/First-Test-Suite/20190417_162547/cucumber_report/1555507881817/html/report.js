$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/HP/git/PMO-Web-Application/Include/features/Main-Features/017-Save-Draft-Idea-then-Send-it.feature");
formatter.feature({
  "name": "Submit draft idea and check it can be editted and deleted",
  "description": "  I want to submit draft idea and check it can be editted and deleted then send it",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@PMO"
